...
class NukeGeoPublishPlugin(HookBaseClass):
    """
    ...
    def icon(self):
        ...
        return os.path.join(self.disk_location, "icons", "geometry.png")
    ...
    def settings(self):
        ...
        plugin_settings = super(NukeGeoPublishPlugin, self).settings or {}
