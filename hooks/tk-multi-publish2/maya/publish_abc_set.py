...
class MayaSessionGeometryPublishPlugin(HookBaseClass):
    ...
    def validate(self, settings, item):
        ...
        work_fields["maya.set_name"] = item.properties.get("set_name")
        ...
        work_fields["name"] = item.properties["set_name"][4:]
    ...
    def publish(self, settings, item):
        ...
        cmds.select(item.properties["set_name"])
